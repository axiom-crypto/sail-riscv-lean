...
/-- Type quantifiers: k_ex476798_ : Bool -/
def trap_callback (x_0 : Bool) (x_1 : (BitVec 6)) : SailM Unit := do
  (internal_error "core/callbacks.sail" 59 "traps fail immediately in the OpenVM model")

/-- Type quantifiers: k_ex476799_ : Bool -/
