...
def read_CSR (merge_var : (BitVec 12)) : SailM (BitVec 32) := do
  ...
  | v__414 =>
    (do
      if ((((Sail.BitVec.extractLsb v__414 11 4) == (0x3A#8 : (BitVec 8))) && (let idx : (BitVec 4) :=
             (Sail.BitVec.extractLsb v__414 3 0)
           (((BitVec.access idx 0) == 0#1) || (xlen == 32)))) : Bool)
      then
        (do
          let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__414 3 0)
          (pmpReadCfgReg (BitVec.toNatInt idx)))
      else
        (do
          if (((Sail.BitVec.extractLsb v__414 11 4) == (0x3B#8 : (BitVec 8))) : Bool)
          then
            (do
              let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__414 3 0)
            ...
            (do
              if (((Sail.BitVec.extractLsb v__414 11 4) == (0x3C#8 : (BitVec 8))) : Bool)
              then
                (do
                  let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__414 3 0)
                ...
                (do
                  if (((Sail.BitVec.extractLsb v__414 11 4) == (0x3D#8 : (BitVec 8))) : Bool)
                  then
                    (do
                      let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__414 3 0)
                    ...
                    (do
                      if (((Sail.BitVec.extractLsb v__414 11 4) == (0x3E#8 : (BitVec 8))) : Bool)
                      then
                        (do
                          let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__414 3 0)
...
def write_CSR (arg0 : (BitVec 12)) (arg1 : (BitVec 32)) : SailM (Result (BitVec 32) Unit) := do
  ...
  | (v__424, value) =>
    (do
      if ((((Sail.BitVec.extractLsb v__424 11 4) == (0x3A#8 : (BitVec 8))) && (let idx : (BitVec 4) :=
             (Sail.BitVec.extractLsb v__424 3 0)
           (((BitVec.access idx 0) == 0#1) || (xlen == 32)))) : Bool)
      then
        (do
          let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__424 3 0)
          let idx := (BitVec.toNatInt idx)
          (pmpWriteCfgReg idx value)
          (pure (Ok (← (pmpReadCfgReg idx)))))
      else
        (do
          if (((Sail.BitVec.extractLsb v__424 11 4) == (0x3B#8 : (BitVec 8))) : Bool)
          then
            (do
              let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__424 3 0)
            ...
            (do
              if (((Sail.BitVec.extractLsb v__424 11 4) == (0x3C#8 : (BitVec 8))) : Bool)
              then
                (do
                  let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__424 3 0)
                ...
                (do
                  if (((Sail.BitVec.extractLsb v__424 11 4) == (0x3D#8 : (BitVec 8))) : Bool)
                  then
                    (do
                      let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__424 3 0)
                    ...
                    (do
                      if (((Sail.BitVec.extractLsb v__424 11 4) == (0x3E#8 : (BitVec 8))) : Bool)
                      then
                        (do
                          let idx : (BitVec 4) := (Sail.BitVec.extractLsb v__424 3 0)
